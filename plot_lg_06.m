...
plot(l_U,lg_06,'^','Color','#003688','LineWidth',2,'MarkerSize',14)

% Triangle6:
sigma_max = 0.061947584726442;
lg_06 = 21.27*sqrt(sqrt(3))/2;
l_U = 0.165528802094570/(sqrt(3)/2);
plot(l_U,lg_06,'>','Color','#9364CD','LineWidth',2,'MarkerSize',14)

% Triangle9:
sigma_max = 0.063644988097432;
lg_06 = 35.6/2;
l_U = 0.139389989079762/0.5;
plot(l_U,lg_06,'v','Color','#E32017','LineWidth',2,'MarkerSize',14)

% Semicircle:
sigma_max = 0.065037357706810;
lg_06 = 27.128*sqrt(pi/8);
l_U = 0.202240488839837/0.5;
plot(l_U,lg_06,'o','Color','#E32017','LineWidth',2,'MarkerSize',14)

% Trapezium:
sigma_max = 0.059962042273510;
lg_06 = 21.27*sqrt(sqrt(3))/2;
l_U = 0.165528802094570/0.5;
plot(l_U,lg_06,'d','Color','#9364CD','LineWidth',2,'MarkerSize',14)
