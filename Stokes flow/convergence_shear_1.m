...
% Define grid sizes
nz = n % number of points in periodic z (spanwise)
ny = n+1; % number of points y (wall-normal) domain is enclosed
...
figure(3)
plot(n_hist, abs(h_hist-0.13895)*100/0.13895,'-o') % 0.14 for triangle9, 0.2 for parabolic
ylabel('h_{||} error')
xlabel('n')
toc